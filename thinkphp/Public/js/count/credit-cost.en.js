...
PMSFLWrite("}\n");
PMSFLWrite("\n");
PMSFLWrite(".pmsfl-calculator  .calc-PT-disclaimer-link {\n");
PMSFLWrite("color:#666666 !important;\n");
PMSFLWrite("text-decoration:underline !important;\n");
PMSFLWrite("padding-left:20px !important;\n");
PMSFLWrite("padding-right:5px !important;\n");
PMSFLWrite("position:relative !important;\n");
PMSFLWrite("top:-5px !important;\n");
PMSFLWrite("}\n");
PMSFLWrite("\n");
...
PMSFLWrite("}\n");
PMSFLWrite("</style>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-credit-cost\" class=\"pmsfl-calculator\">\n");
PMSFLWrite("<div class=\"calc-outer\">\n");
PMSFLWrite("<div class=\"calc-inner\">\n");
PMSFLWrite("<h1>信用卡成本</h1>\n");
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("您的信用卡有债务吗？如果您积累了大笔的信用卡债务，那就很有可能面对惊人的利息费用。来算算使用信用卡的成本吧！");
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
PMSFLWrite("<form>\n");
PMSFLWrite("<table>\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-col-1of4\">信用卡支付总额");
PMSFLWrite("\n");
PMSFLWrite("<span class=\"calc-help-details\" style=\"display:none\">\n");
PMSFLWrite("<br/>This is how much you charge to your credit card\n");
PMSFLWrite("</span>\n");
PMSFLWrite("</td>\n");
PMSFLWrite("<td class=\"calc-col-2of4\">￥</td>\n");
PMSFLWrite("<td class=\"calc-col-3of4\"><input name=\"tpa\" type=\"text\" id=\"tpa\" value=\"\" size=\"10\"/></td>\n");
PMSFLWrite("<td class=\"calc-col-4of4\">&#160;</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>信用卡年利率");
PMSFLWrite("\n");
PMSFLWrite("<span class=\"calc-help-details\" style=\"display:none\">\n");
PMSFLWrite("<br/>This is the annual interest rate charged by your credit card\n");
PMSFLWrite("</span>\n");
PMSFLWrite("</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("<td><input name=\"apr\" type=\"text\" id=\"apr\" value=\"\" size=\"10\"/></td>\n");
PMSFLWrite("<td>%</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>计划每月支付");
PMSFLWrite("\n");
PMSFLWrite("<span class=\"calc-help-details\" style=\"display:none\">\n");
PMSFLWrite("<br/>This is how much you intend to pay each month to pay\n");
PMSFLWrite("off your credit card bill\n");
PMSFLWrite("</span>\n");
PMSFLWrite("</td>\n");
PMSFLWrite("<td>￥</td>\n");
PMSFLWrite("<td><input name=\"mp\" type=\"text\" id=\"mp\" value=\"\" size=\"10\"/></td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("<tr>\n");
...
PMSFLWrite("<div id=\"pmsfl-calculator-credit-cost-err1\">请输入一个有效的金额</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-credit-cost-err2\">请输入有效的信用卡利息</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-credit-cost-err3\">请输入一个有效的月支付</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-credit-cost-err4\">根据您输入的数值，您偿还债务时会遇到困难。请您输入合适的数值再进行计算</div>\n");
PMSFLWrite("</div>\n");
PMSFLWrite("\n");
PMSFLWrite("<div class=\"calc-output\" style=\"display:none\">\n");
PMSFLWrite("<h2>输入结果</h2>\n");
PMSFLWrite("\n");
PMSFLWrite("<table>\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>还清信用卡所需月数</td>\n");
PMSFLWrite("<td></td>\n");
PMSFLWrite("<td><span id=\"pmsfl-calculator-credit-cost-nummon\"></span></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>最后一笔支付金额</td>\n");
PMSFLWrite("<td>￥</td>\n");
PMSFLWrite("<td><span id=\"pmsfl-calculator-credit-cost-finalpay\"></span></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>总利息费用</td>\n");
PMSFLWrite("<td>￥</td>\n");
PMSFLWrite("<td><span id=\"pmsfl-calculator-credit-cost-finalcharge\"></span></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td><strong>总支出:</strong></td>\n");
PMSFLWrite("<td><strong>￥</strong></td>\n");
PMSFLWrite("<td><strong><span id=\"pmsfl-calculator-credit-cost-totalcost\"></span></strong></td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("</table>\n");
PMSFLWrite("</div>\n");
PMSFLWrite("\n");
...
PmsflCalc('credit-cost', function (helper) {
  var tpa = helper.parseFloat('tpa');
  var apr = helper.parseFloat('apr');
  var mp  = helper.parseFloat('mp');

  if (isNaN(tpa)) {return helper.alert(1, 'tpa');}
  if (isNaN(apr)) {return helper.alert(2, 'apr');}
  if (isNaN(mp))  {return helper.alert(3, 'mp');}
  ...
  var mi = mr;
  var bi = (apr / (26.0 * 100.0));
  var first_interest_pmt = mi * tpa;
  ...
  if (apr > 0) {
    ...
    tmp4 = Math.log(tmp3);
    tmp5 = tmp4 * (-1.0);
    tmp6 = Math.log(1.0 + mr);

    nummon = (tmp5 / tmp6) + 1.0;
        wm = Math.floor(nummon);

    finalpay = (nummon - wm) * mp;
    totcost  = (nummon - 1.0) * mp;
    fincharg = totcost - tpa;
  ...
  helper.set('nummon', Math.floor(nummon).toFixed(0));
  helper.set('finalpay', finalpay.toFixed(2));
  helper.set('finalcharge', fincharg.toFixed(2));
  helper.set('totalcost', totcost.toFixed(2));
  helper.show();
});
