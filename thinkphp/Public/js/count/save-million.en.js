...
PMSFLWrite("\n");
PMSFLWrite("</style>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-save-million\" class=\"pmsfl-calculator\">\n");
PMSFLWrite("<div class=\"calc-outer\">\n");
PMSFLWrite("<div class=\"calc-inner\">\n");
PMSFLWrite("<h1>存下一百万</h1>\n");
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("通过储蓄能成为百万富翁吗？这个计算器可以帮你规划财务，达到未来的目标。\n");
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
PMSFLWrite("<form>\n");
PMSFLWrite("<table>\n");
PMSFLWrite("<tbody>\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td class=\"calc-col-1of4\">您的存款目标（100万或者其他）</td>\n");
PMSFLWrite("<td class=\"calc-col-2of4\">￥</td>\n");
PMSFLWrite("<td class=\"calc-col-3of4\"><input name=\"goal\" value=\"1,000,000\" type=\"text\" size=\"10\"/></td>\n");
PMSFLWrite("<td class=\"calc-col-4of4\">&#160;</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>您现在的年龄</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("<td><input name=\"age_now\" type=\"text\" size=\"10\"/></td>\n");
PMSFLWrite("<td>岁</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>您希望什么时候达到目标</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("<td><input name=\"age_goal\" type=\"text\" size=\"10\"/></td>\n");
PMSFLWrite("<td>岁</td>\n");
PMSFLWrite("</tr>\n");
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>您现在有多少存款？</td>\n");
PMSFLWrite("<td>￥</td>\n");
...
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>您多长时间存一次钱？</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
PMSFLWrite("<td>\n");
PMSFLWrite("<select name=\"freq\">\n");
PMSFLWrite("<option value=\"1\">每年</option>\n");
PMSFLWrite("<option value=\"12\">每月</option>\n");
PMSFLWrite("<option value=\"26\">两周一次</option>\n");
...
PMSFLWrite("\n");
PMSFLWrite("<tr>\n");
PMSFLWrite("<td>您预计您的存款账户的年利率是多少？</td>\n");
PMSFLWrite("<td>&#160;</td>\n");
...
PMSFLWrite("<div id=\"pmsfl-calculator-save-million-err1\">请输入一个合理的数值.</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-save-million-err2\">请输入一个合理的年龄.</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-save-million-err3\">请输入年利率.</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-save-million-err4\">根据您输入的数值，您偿还债务时会遇到困难。请您输入合适的数值再进行计算</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-save-million-err5\">您已达到设定的目标</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-save-million-msg1\">年</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-save-million-msg2\">月</div>\n");
PMSFLWrite("<div id=\"pmsfl-calculator-save-million-msg3\">周</div>\n");
PMSFLWrite("</div>\n");
PMSFLWrite("\n");
...
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("您的存款目标：<span id=\"pmsfl-calculator-save-million-goal\"></span>元.\n");
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("以您现在的储蓄率，包括赚取的利息在内，您需要花\n");
PMSFLWrite("<span id=\"pmsfl-calculator-save-million-goal_years\"></span>\n");
PMSFLWrite("年时间达到目标。\n");
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
PMSFLWrite("<p class=\"calc-output-million\">\n");
PMSFLWrite("It will take you\n");
PMSFLWrite("<span id=\"pmsfl-calculator-save-million-million_years\"></span>\n");
PMSFLWrite("years to save a million\n");
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
PMSFLWrite("<p>\n");
PMSFLWrite("为了达到您在\n");
PMSFLWrite("<span id=\"pmsfl-calculator-save-million-want_years\"></span>\n");
PMSFLWrite("年内存够这么多钱的目标，您需要每<span id=\"pmsfl-calculator-save-million-save_freq1\"></span>存入\n");
PMSFLWrite("￥<span id=\"pmsfl-calculator-save-million-goal_save\"></span>\n");
PMSFLWrite("\n");
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
PMSFLWrite("<p class=\"calc-output-million\">\n");
PMSFLWrite("To save a million in the same time you will need to save\n");
PMSFLWrite("$<span id=\"pmsfl-calculator-save-million-million_save\"></span>\n");
PMSFLWrite("per <span id=\"pmsfl-calculator-save-million-save_freq2\"></span>.\n");
PMSFLWrite("</p>\n");
PMSFLWrite("\n");
PMSFLWrite("</div>\n");
PMSFLWrite("\n");
...
PmsflCalc('save-million', {
  calculate: function (helper) {
    var goal = helper.parseFloat('goal');
    var age_now = helper.parseFloat('age_now');
    var age_goal = helper.parseFloat('age_goal');
    var saved = helper.parseFloat('saved', '0');
    var deposit = helper.parseFloat('deposit');
    var freq = helper.parseFloat('freq', '1');
    var irate = helper.parseFloat('irate');

    if (isNaN(goal)) {return helper.alert(1, 'goal');}
    if (isNaN(age_now)) {return helper.alert(2, 'age_now');}
    if (isNaN(age_goal)) {return helper.alert(2, 'age_goal');}
    if (isNaN(saved)) {return helper.alert(1, 'saved');}
    if (isNaN(deposit)) {return helper.alert(1, 'deposit');}
    if (isNaN(irate)) {return helper.alert(3, 'irate');}
    ...
    if (i > 0) {
      ...
      ntotal_mil = Math.log((vv + y) / (p + y)) / (q * Math.log(1.0 + i/q));
      mtotal_mil = (i * (vv - p * x))/(q * (x - 1.0));
    } else {
      ntotal = (v - p)/(m*q);
      mtotal = (v - p)/(n*q);
      ntotal_mil = (vv - p)/(m*q);
    ...
    if (px > v) {mtotal = 0.0;}
    if (px > vv) {mtotal_mil = 0.0;}

    var want_years = age_goal - age_now;
    var goal_years = ntotal;
    var goal_save = mtotal;
    helper.set('want_years', Math.ceil(want_years) + ' ', false);
    helper.set('goal', goal.toFixed(2));
    helper.set('goal_years', Math.ceil(goal_years) + ' ', false);
    helper.set('goal_save', goal_save.toFixed(2));
    
    var million_years = ntotal_mil;
    var million_save = mtotal_mil;
    helper.set('million_years', Math.ceil(million_years) + ' ', false);
    helper.set('million_save', million_save.toFixed(2));
    ...
    save_freq = helper.msg(save_freq);
    helper.set('save_freq1', save_freq, false);
    helper.set('save_freq2', save_freq, false);

    var million_elements = $('#' + helper.id + ' .calc-output .calc-output-million');

    if (goal == vv) {
      million_elements.hide();
    } else {
      million_elements.show();
    }
